...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c1 = function(sourceAndsearch, tailArr) {
      ...
      peg$c3 = function(sourceArr, searchArr) {
      ...
      peg$c13 = function(fieldObj, op, value) {
      ...
      peg$c15 = function(fieldObj, values) {
          const { fieldName, fieldType } = fieldObj;
      ...
      peg$c17 = function(fieldObj, values) {
          const { fieldName, fieldType } = fieldObj;
          const { paramKey, paramName } = getLocation(fieldName, fieldType);
      ...
      peg$c25 = function(fieldObj, value) {
          const { fieldName, fieldType } = fieldObj;
      ...
      peg$c27 = function(fieldObj, value) {
          const { fieldName, fieldType } = fieldObj;
      ...
      peg$c36 = function(op, field) { return {op: op || '+', field} },
      peg$c37 = peg$otherExpectation("MoreColumns"),
      peg$c38 = function(field) { return field },
      ...
      peg$c42 = function(op, first, rest) {
       	  // +ip/ip ==> {ip: {order: 'asc'}}
          // -ip ==> {ip: {order: 'desc'}}
          // [[操作符, 字段], [操作符, 字段]]
      ...
      peg$c44 = function(op, field) { return [op, field] },
      ...
      peg$c50 = function(field, startTime, endTimeArr) {
      ...
      peg$c60 = function(number, timeUnit) {
      ...
      peg$c64 = function() { return currentTime },
      ...
      peg$c92 = function(year, month, day, hours, minutes, seconds, timeZone) {
      ...
      peg$c94 = function(year, month, day, hours, minutes, seconds) {
         if(String(year).length !== 4 || String(month).length !== 2 || String(day).length !== 2 || String(hours).length !== 2 || String(minutes).length !== 2 || String(seconds).length !== 2) {
      ...
      peg$c98 = function(num) { return num.join('') },
      ...
      peg$c106 = function(op, numberArr, suffix) {
      ...
      peg$c127 = function(frist, second) {
