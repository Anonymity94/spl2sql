 ...
 * @buildAt 2020-12-07T10:01:12.730Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      if (tailMap.GENTIMES) {
        ...
        timeSql += '(';
        timeSql += " start_time >= toDateTime64(".concat(agingStartTime, ", 9, 'UTC') ");
        timeSql += " and start_time < toDateTime64(".concat(endTime, ", 9, 'UTC') ");
        timeSql += " and end_time >= toDateTime64(".concat(startTime, ", 9, 'UTC') ");
