 ...
 * @buildAt 2020-10-26T01:36:08.458Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return "";
        ...
        peg$c136 = /^[\u4E00-\u9FA5_a-zA-Z0-9.\-?*:\/<> =,]/,
        peg$c137 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ".", "-", "?", "*", ":", "/", "<", ">", " ", "=", ","], false, false),
        peg$c138 = function peg$c138(num) {
      ...
      return false;
        ...
        peg$c169 = "source",
        peg$c170 = peg$literalExpectation("SOURCE", true),
        peg$c171 = "search",
        peg$c172 = peg$literalExpectation("SEARCH", true),
        peg$c173 = "fields",
        peg$c174 = peg$literalExpectation("FIELDS", true),
        peg$c175 = "head",
        peg$c176 = peg$literalExpectation("HEAD", true),
        peg$c177 = "sort",
        peg$c178 = peg$literalExpectation("SORT", true),
        peg$c179 = "gentimes",
        peg$c180 = peg$literalExpectation("GENTIMES", true),
        peg$c181 = "size",
        peg$c182 = peg$literalExpectation("SIZE", true),
        peg$c183 = "timeout",
        peg$c184 = peg$literalExpectation("TIMEOUT", true),
        peg$c185 = "track_total_hits",
        peg$c186 = peg$literalExpectation("TRACK_TOTAL_HITS", true),
        peg$c187 = "terminate_after",
        peg$c188 = peg$literalExpectation("TERMINATE_AFTER", true),
        peg$c189 = "top",
        peg$c190 = peg$literalExpectation("TOP", true),
        peg$c191 = "limit",
        peg$c192 = peg$literalExpectation("LIMIT", true),
        peg$c193 = "in",
        peg$c194 = peg$literalExpectation("IN", true),
        peg$c195 = "not in",
        peg$c196 = peg$literalExpectation("NOT IN", true),
        peg$c197 = "like",
        peg$c198 = peg$literalExpectation("LIKE", true),
        peg$c199 = "not like",
        peg$c200 = peg$literalExpectation("NOT LIKE", true),
        peg$currPos = 0,
        peg$savedPos = 0,
        peg$posDetailsCache = [{
      line: 1,
    ...
    function peg$parseTRACK_TOTAL_HITS() {
      ...
      if (input.substr(peg$currPos, 16).toLowerCase() === peg$c185) {
    ...
    function peg$parseTERMINATE_AFTER() {
      ...
      if (input.substr(peg$currPos, 15).toLowerCase() === peg$c187) {
