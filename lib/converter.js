 ...
 * @buildAt 2021-08-12T08:06:32.396Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return isNum ? Number(str) : str;
        ...
        peg$c142 = function peg$c142(_char2) {
      return _char2.join('');
    },
        peg$c143 = /^[^']/,
      ...
      return "";
        ...
        peg$c147 = function peg$c147(num) {
      ...
      return false;
        ...
        peg$c178 = "source",
        peg$c179 = peg$literalExpectation("SOURCE", true),
        peg$c180 = "search",
        peg$c181 = peg$literalExpectation("SEARCH", true),
        peg$c182 = "fields",
        peg$c183 = peg$literalExpectation("FIELDS", true),
        peg$c184 = "head",
        peg$c185 = peg$literalExpectation("HEAD", true),
        peg$c186 = "sort",
        peg$c187 = peg$literalExpectation("SORT", true),
        peg$c188 = "gentimes",
        peg$c189 = peg$literalExpectation("GENTIMES", true),
        peg$c190 = "size",
        peg$c191 = peg$literalExpectation("SIZE", true),
        peg$c192 = "timeout",
        peg$c193 = peg$literalExpectation("TIMEOUT", true),
        peg$c194 = "track_total_hits",
        peg$c195 = peg$literalExpectation("TRACK_TOTAL_HITS", true),
        peg$c196 = "terminate_after",
        peg$c197 = peg$literalExpectation("TERMINATE_AFTER", true),
        peg$c198 = "top",
        peg$c199 = peg$literalExpectation("TOP", true),
        peg$c200 = "limit",
        peg$c201 = peg$literalExpectation("LIMIT", true),
        peg$c202 = "in",
        peg$c203 = peg$literalExpectation("IN", true),
        peg$c204 = "not in",
        peg$c205 = peg$literalExpectation("NOT IN", true),
        peg$c206 = "like",
        peg$c207 = peg$literalExpectation("LIKE", true),
        peg$c208 = "not like",
        peg$c209 = peg$literalExpectation("NOT LIKE", true),
        peg$c210 = "exists",
        peg$c211 = peg$literalExpectation("EXISTS", true),
        peg$c212 = "not_exists",
        peg$c213 = peg$literalExpectation("NOT_EXISTS", true),
        peg$currPos = 0,
        peg$savedPos = 0,
        peg$posDetailsCache = [{
      line: 1,
    ...
    function peg$parseTRACK_TOTAL_HITS() {
      ...
      if (input.substr(peg$currPos, 16).toLowerCase() === peg$c194) {
