 ...
 * @buildAt 2021-08-06T08:55:49.715Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return str;
        ...
        peg$c135 = peg$otherExpectation("QuotedValue"),
        peg$c136 = /^[\u4E00-\u9FA5_a-zA-Z0-9a-zA-Z0-9~\xB7!@#$%\^&*()_\-+={}[\]\\<>,.?\/:;\uFF01\uFFE5\uFF1B\uFF1A\uFF0C\u3002 ]/,
        peg$c137 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ["a", "z"], ["A", "Z"], ["0", "9"], "~", "\xB7", "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "-", "+", "=", "{", "}", "[", "]", "\\", "<", ">", ",", ".", "?", "/", ":", ";", "\uFF01", "\uFFE5", "\uFF1B", "\uFF1A", "\uFF0C", "\u3002", " "], false, false),
        peg$c138 = peg$otherExpectation("Value"),
        peg$c139 = /^[^"]/,
      ...
      return "";
        ...
        peg$c146 = function peg$c146(num) {
      return parseInt(num.join(''));
    },
        peg$c147 = "and",
        peg$c148 = peg$literalExpectation("AND", true),
        peg$c149 = "&&",
      ...
      return AND;
        ...
        peg$c152 = "or",
        peg$c153 = peg$literalExpectation("OR", true),
        peg$c154 = "||",
      ...
      return false;
        ...
        peg$c177 = "source",
        peg$c178 = peg$literalExpectation("SOURCE", true),
        peg$c179 = "search",
        peg$c180 = peg$literalExpectation("SEARCH", true),
        peg$c181 = "fields",
        peg$c182 = peg$literalExpectation("FIELDS", true),
        peg$c183 = "head",
        peg$c184 = peg$literalExpectation("HEAD", true),
        peg$c185 = "sort",
        peg$c186 = peg$literalExpectation("SORT", true),
        peg$c187 = "gentimes",
        peg$c188 = peg$literalExpectation("GENTIMES", true),
        peg$c189 = "size",
        peg$c190 = peg$literalExpectation("SIZE", true),
        peg$c191 = "timeout",
        peg$c192 = peg$literalExpectation("TIMEOUT", true),
        peg$c193 = "track_total_hits",
        peg$c194 = peg$literalExpectation("TRACK_TOTAL_HITS", true),
        peg$c195 = "terminate_after",
        peg$c196 = peg$literalExpectation("TERMINATE_AFTER", true),
        peg$c197 = "top",
        peg$c198 = peg$literalExpectation("TOP", true),
        peg$c199 = "limit",
        peg$c200 = peg$literalExpectation("LIMIT", true),
        peg$c201 = "in",
        peg$c202 = peg$literalExpectation("IN", true),
        peg$c203 = "not in",
        peg$c204 = peg$literalExpectation("NOT IN", true),
        peg$c205 = "like",
        peg$c206 = peg$literalExpectation("LIKE", true),
        peg$c207 = "not like",
        peg$c208 = peg$literalExpectation("NOT LIKE", true),
        peg$c209 = "exists",
        peg$c210 = peg$literalExpectation("EXISTS", true),
        peg$c211 = "not_exists",
        peg$c212 = peg$literalExpectation("NOT_EXISTS", true),
        peg$currPos = 0,
        peg$savedPos = 0,
        peg$posDetailsCache = [{
      line: 1,
    ...
    function peg$parseTRACK_TOTAL_HITS() {
      ...
      if (input.substr(peg$currPos, 16).toLowerCase() === peg$c193) {
    ...
    function peg$parseTERMINATE_AFTER() {
      ...
      if (input.substr(peg$currPos, 15).toLowerCase() === peg$c195) {
