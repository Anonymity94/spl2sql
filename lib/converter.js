 ...
 * @buildAt 2021-07-27T02:18:09.746Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      if (tailMap.GENTIMES) {
        ...
        var endTime = getUtcDate(time_to); // 根本开始时间推算流的老化时间
        ...
        if (hasAgingTime) {
          ...
          timeSql += '(`' + time_field + '`' + ">= toDateTime64(:param_start_time, ".concat(timePrecision, ", 'UTC') AND ") + '`' + time_field + '`' + " <= toDateTime64(:param_end_time, ".concat(timePrecision, ", 'UTC'))");
        }
      ...
      return 'empty(`' + fieldName + '`)';
        ...
        peg$c32 = /^[\u4E00-\u9FA5_a-zA-Z0-9a-zA-Z0-9._\-%:_[,\]\^\/]/,
        peg$c33 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ["a", "z"], ["A", "Z"], ["0", "9"], ".", "_", "-", "%", ":", "_", "[", ",", "]", "^", "/"], false, false),
        peg$c34 = "\"",
        peg$c35 = peg$literalExpectation("\"", false),
        peg$c36 = function peg$c36(_char) {
      return _char;
    },
        peg$c37 = "'",
        ...
        peg$c41 = peg$otherExpectation("TailCommand"),
        peg$c42 = peg$otherExpectation("FieldsCommand"),
        peg$c43 = function peg$c43(first, rest) {
      ...
      return {
        ...
        peg$c45 = function peg$c45(op, field) {
      return {
        op: op || '+',
        field: field
      };
    },
        peg$c46 = peg$otherExpectation("MoreColumns"),
        peg$c47 = function peg$c47(field) {
      return field;
    },
        peg$c48 = peg$otherExpectation("HeadCommand"),
      ...
      return {
        ...
        peg$c50 = peg$otherExpectation("SortCommand"),
        peg$c51 = function peg$c51(op, first, rest) {
      // +ip/ip ==> {ip: {order: 'asc'}}
      // -ip ==> {ip: {order: 'desc'}}
      // [[操作符, 字段], [操作符, 字段]]
      ...
      return {
        ...
        peg$c52 = peg$otherExpectation("MoreSort"),
        peg$c53 = function peg$c53(op, field) {
      return [op, field];
    },
        peg$c54 = peg$otherExpectation("GentimesCommand"),
        peg$c55 = "start",
        peg$c56 = peg$literalExpectation("start", true),
        peg$c57 = "end",
        peg$c58 = peg$literalExpectation("end", true),
        peg$c59 = function peg$c59(field, startTime, endTimeArr) {
      ...
      return {
        ...
        peg$c60 = peg$otherExpectation("TimeValue"),
        peg$c61 = peg$otherExpectation("RelativeTime"),
        peg$c62 = "now-",
        peg$c63 = peg$literalExpectation("now-", false),
        peg$c64 = function peg$c64(number, timeUnit) {
      ...
      return new Date(endTime).getTime();
        ...
        peg$c65 = peg$otherExpectation("now"),
        peg$c66 = "now",
        peg$c67 = peg$literalExpectation("now", false),
        peg$c68 = function peg$c68() {
      return currentTime;
    },
        peg$c69 = peg$otherExpectation("TimeUnit"),
        peg$c70 = "y",
        peg$c71 = peg$literalExpectation("y", false),
        peg$c72 = "M",
        peg$c73 = peg$literalExpectation("M", false),
        peg$c74 = "w",
        peg$c75 = peg$literalExpectation("w", false),
        peg$c76 = "d",
        peg$c77 = peg$literalExpectation("d", false),
        peg$c78 = "h",
        peg$c79 = peg$literalExpectation("h", false),
        peg$c80 = "H",
        peg$c81 = peg$literalExpectation("H", false),
        peg$c82 = "m",
        peg$c83 = peg$literalExpectation("m", false),
        peg$c84 = "s",
        peg$c85 = peg$literalExpectation("s", false),
        peg$c86 = function peg$c86() {
      return text();
    },
        peg$c87 = peg$otherExpectation("Timestamp"),
        peg$c88 = function peg$c88(timestamp) {
      ...
      return timestamp;
        ...
        peg$c89 = peg$otherExpectation("UTCTime"),
        peg$c90 = "-",
        ...
        peg$c96 = function peg$c96(year, month, day, hours, minutes, seconds, timeZone) {
      ...
      return new Date(time).getTime();
        ...
        peg$c97 = peg$otherExpectation("YYYYMMDDHHmmss"),
        peg$c98 = function peg$c98(year, month, day, hours, minutes, seconds) {
      if (String(year).length !== 4 || String(month).length !== 2 || String(day).length !== 2 || String(hours).length !== 2 || String(minutes).length !== 2 || String(seconds).length !== 2) {
      ...
      return new Date(text().replace(/ /, 'T') + getTimeZone()).getTime();
        ...
        peg$c99 = peg$otherExpectation("TimeInteger"),
        peg$c100 = /^[0-9]/,
        peg$c101 = peg$classExpectation([["0", "9"]], false, false),
        peg$c102 = function peg$c102(num) {
      return num.join('');
    },
        peg$c103 = peg$otherExpectation("TimeZone"),
        peg$c104 = "+",
        peg$c105 = peg$literalExpectation("+", false),
        peg$c106 = "00",
        peg$c107 = peg$literalExpectation("00", false),
        peg$c108 = ":00",
        peg$c109 = peg$literalExpectation(":00", false),
        peg$c110 = function peg$c110(op, numberArr, suffix) {
      ...
      return [op, numberstring.slice(0, 2), suffix];
        ...
        peg$c115 = peg$otherExpectation("DataSource"),
        peg$c116 = /^[a-zA-Z0-9._\-*]/,
        peg$c117 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], ".", "_", "-", "*"], false, false),
        peg$c118 = peg$otherExpectation("Field"),
        peg$c119 = /^[A-Za-z0-9_.]/,
        peg$c120 = peg$classExpectation([["A", "Z"], ["a", "z"], ["0", "9"], "_", "."], false, false),
        peg$c121 = function peg$c121(str) {
      ...
      return field;
        ...
        peg$c122 = peg$otherExpectation("FieldWithType"),
        peg$c123 = function peg$c123(str, type) {
      var field = str.join('');
      ...
      return {
        ...
        peg$c124 = peg$otherExpectation("FieldType"),
        peg$c125 = "<",
        ...
        peg$c131 = function peg$c131(frist, second) {
      ...
      return str + (second ? "<".concat(second, ">") : '');
        ...
        peg$c132 = peg$otherExpectation("FieldSecondType"),
        peg$c133 = /^[A-Za-z0-9_]/,
        peg$c134 = peg$classExpectation([["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false),
        peg$c135 = function peg$c135(arr) {
      var str = arr.join('');
      ...
      return str;
        ...
        peg$c136 = peg$otherExpectation("Value"),
        peg$c137 = /^[\u4E00-\u9FA5_a-zA-Z0-9.\-?*:\/]/,
        peg$c138 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ".", "-", "?", "*", ":", "/"], false, false),
        peg$c139 = /^[^"]/,
        peg$c140 = peg$classExpectation(["\""], true, false),
        peg$c141 = function peg$c141(_char2) {
      return _char2.join('');
    },
        peg$c142 = /^[^']/,
      ...
      return "";
        ...
        peg$c146 = peg$otherExpectation("QuotedValue"),
        peg$c147 = /^[\u4E00-\u9FA5_a-zA-Z0-9.\-?*:\/<> =,]/,
        peg$c148 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ".", "-", "?", "*", ":", "/", "<", ">", " ", "=", ","], false, false),
      ...
      return AND;
        ...
        peg$c155 = "or",
        peg$c156 = peg$literalExpectation("OR", true),
        peg$c157 = "||",
      ...
      return false;
        ...
        peg$c180 = "source",
        peg$c181 = peg$literalExpectation("SOURCE", true),
        peg$c182 = "search",
        peg$c183 = peg$literalExpectation("SEARCH", true),
        peg$c184 = "fields",
        peg$c185 = peg$literalExpectation("FIELDS", true),
        peg$c186 = "head",
        peg$c187 = peg$literalExpectation("HEAD", true),
        peg$c188 = "sort",
        peg$c189 = peg$literalExpectation("SORT", true),
        peg$c190 = "gentimes",
        peg$c191 = peg$literalExpectation("GENTIMES", true),
        peg$c192 = "size",
        peg$c193 = peg$literalExpectation("SIZE", true),
        peg$c194 = "timeout",
        peg$c195 = peg$literalExpectation("TIMEOUT", true),
        peg$c196 = "track_total_hits",
        peg$c197 = peg$literalExpectation("TRACK_TOTAL_HITS", true),
        peg$c198 = "terminate_after",
        peg$c199 = peg$literalExpectation("TERMINATE_AFTER", true),
        peg$c200 = "top",
        peg$c201 = peg$literalExpectation("TOP", true),
        peg$c202 = "limit",
        peg$c203 = peg$literalExpectation("LIMIT", true),
        peg$c204 = "in",
        peg$c205 = peg$literalExpectation("IN", true),
        peg$c206 = "not in",
        peg$c207 = peg$literalExpectation("NOT IN", true),
        peg$c208 = "like",
        peg$c209 = peg$literalExpectation("LIKE", true),
        peg$c210 = "not like",
        peg$c211 = peg$literalExpectation("NOT LIKE", true),
        peg$c212 = "exists",
        peg$c213 = peg$literalExpectation("EXISTS", true),
        peg$c214 = "not_exists",
        peg$c215 = peg$literalExpectation("NOT_EXISTS", true),
        peg$currPos = 0,
        peg$savedPos = 0,
        peg$posDetailsCache = [{
      line: 1,
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          ...
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s12 !== peg$FAILED) {
                              peg$savedPos = s0;
                              s1 = peg$c96(s1, s3, s5, s7, s9, s11, s12);
                              s0 = s1;
                            } else {
                              peg$currPos = s0;
                              s0 = peg$FAILED;
    ...
    function peg$parseTRACK_TOTAL_HITS() {
      ...
      if (input.substr(peg$currPos, 16).toLowerCase() === peg$c196) {
    ...
    function peg$parseTERMINATE_AFTER() {
      ...
      if (input.substr(peg$currPos, 15).toLowerCase() === peg$c198) {
